...
//BASE DE DATOS
 var productos = ["Tolueno/25 mL", "Xileno/25 mL", "Acetato de etilo/25 mL", "Acetato de butilo/25 mL", "Acetona/25 mL", "M.Isobutilcetona/25 mL", "Metanol/25 mL", "Isopropanol/25 mL", "Percloroetileno/25 mL"];
 var imgGrandes = ["1T.jpg", "2T.jpg", "3T.jpg", "4T.jpg", "5T.jpg", "6T.jpg", "7T1.jpg", "8T.jpg", "9T.jpg"];
 var imgPeque = ["1T.jpg", "2T.jpg", "3T.jpg", "4T.jpg", "5T.jpg", "6T.jpg", "7T1.jpg", "8T.jpg", "9T.jpg"];
...
//JAVASCRIPT A EJECUTARSE UNA VEZ CARGADA LA PAGINA: 
 ...
 for (i in productos){
 DIVS[i].innerHTML = '<a id="imgG'+i+'" href="' +imgGrandes[i]+ '"><img id="imgP'+i+'" class="imagen" src="' +imgPeque[i]+ '"></a><div class="etiquetas"><span id="pro'+i+'">' +productos[i]+ '</span>: <span id="pre'+i+'">' +precios[i]+ '$</span></b></div><div class="stock">Es una sustancia utilizada<br/>para diluir otras sustancias: <input class="uniBien" type="number" id="uniUser'+i+'" name="uniUser" value="0" size="4" /></div>';
 }
...
/**/ document.getElementById("divPago").className = "divsNo"; 
 ...
 document.getElementById("tablaTotal").innerHTML = tablaTotal + '<tr><td> </td> <td></td><td class="preUni"><b>Transporte: </b></td><td class="preTotal"><b>' +totalTransporte+ '</b></td></tr>' + '<tr><td> </td> <td></td><td class="preUni"><b>ITBMS ('+(IVA*100)+'%): </b></td><td class="preTotal"><b>' +totalIVA+ '</b></td></tr>' + '<tr><td> </td> <td></td><td class="preUni"><b>Total: </b></td><td class="preTotal" id="totalAPagar"><b>' +totalAPagar+ ' $</b></td></tr>';
 } 
...
//FUNCION DE VALIDAR DATOS PAGO y ENVIAR DATOS
 ...
 alert("Gracias por su compra, en 24 horas recibira su pedido\nAhora se le reiniciara la página,El registro que realizo fue enviado a su correo.");
